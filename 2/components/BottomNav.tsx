...
export default function BottomNav() {
  ...
  return (
    <nav
      ...
      className={`fixed inset-x-3 bottom-3 z-40 flex items-center gap-1 rounded-full border border-cobalt/15 bg-white/95 p-1 shadow-[0_8px_24px_-8px_rgba(74,18,28,0.45)] backdrop-blur-md transition-transform duration-300 md:hidden ${
