...
// Playfair Display — high-contrast serif for all headings and the wordmark.
const displayFont = Playfair_Display({
  subsets: ["latin"],
  variable: "--font-display",
});

// Playfair Display italic doubles as the script/tagline accent, keeping the type system to two families.
...
// DM Sans — clean sans for body copy, nav and UI.
