...
/**
 * Two spit rods carrying a bar top and bottom, with content standing
 * between them — a rack the content actually rests on, rather than a
 * decorated margin.
 *
 * The rods are hidden below `sm`: at phone width there isn't room for
 * them to read as a frame, and squeezing them in just steals space from
 * the content they're meant to carry.
 */
